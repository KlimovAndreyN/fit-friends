...
export { type ICreateUserDto } from './lib/interfaces/dto/i-create-user-with-avarat-file.dto';
...
export { type IUserRdo } from './lib/interfaces/rdo/i-user-with-avarat-file.rdo';
