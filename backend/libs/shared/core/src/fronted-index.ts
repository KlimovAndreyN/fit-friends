...
export { type IUserQuery } from './lib/interfaces/query/i-user.query';
...
export { type IUserProfilesWithPaginationRdo } from './lib/interfaces/rdo/i-user-profiles-with-pagination.rdo';
