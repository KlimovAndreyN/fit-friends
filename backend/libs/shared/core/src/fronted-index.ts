...
export { type IFriendRdo } from './lib/interfaces/rdo/i-friend-profile.rdo';
export { type IFriendsWithPaginationRdo } from './lib/interfaces/rdo/i-friends-profiles-with-pagination.rdo';
