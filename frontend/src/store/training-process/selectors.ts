...
export const getMaxPriceTrainings = ({ [StoreSlice.TrainingProcess]: TRAINING_PROCESS }: State): TrainingProcess['trainingsMaxPrice'] => TRAINING_PROCESS.trainingsMaxPrice;
