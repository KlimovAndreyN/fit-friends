...
export const getCoachCertificates = ({ [StoreSlice.UserProfileProcess]: USER_PROFILE_PROCESS }: State): UserProfileProcess['coachCertificates'] => USER_PROFILE_PROCESS.coachCertificates;
...
export const getIsUpdateCoachCertificatesExecuting = ({ [StoreSlice.UserProfileProcess]: USER_PROFILE_PROCESS }: State): UserProfileProcess['isUpdateCoachCertificatesExecuting'] => USER_PROFILE_PROCESS.isUpdateCoachCertificatesExecuting;
