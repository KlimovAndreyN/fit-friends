...
const SvgOption = {
  ...
  PERSONAL_ACCOUNT: <svg width="16" height="18" aria-hidden="true"><use xlinkHref="#icon-user" /></svg>,
  FRIENDS_LIST: <svg width="22" height="16" aria-hidden="true"><use xlinkHref="#icon-friends" /></svg>,
  NOTIFICATIONS: <svg width="14" height="18" aria-hidden="true"><use xlinkHref="#icon-notification" /></svg>,
  ...
  return (
    <nav className="main-nav">
      <ul className="main-nav__list">
        <MainNavigateItem title='На главную' linkTo={AppRoute.Index} svg={SvgOption.HOME} isActive={homeIsActive} />
