...
function Trainings(props: TrainingsProps): JSX.Element {
  ...
  //! Фильтры - бесплатные, что то делать с фильтром цена... может задизаблить...
  //! page - проверка на положительное - проверить!
  //! ссыка на тренера, если тренер не я
  //! тренировки тренера добавить фильтр по тренеру в api -> fit
  ...
  //! показать еще - прокрутить вниз, т.к. чтобы посстреть нужно прокручивать, что по ТЗ?
